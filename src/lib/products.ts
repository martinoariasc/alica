...
export const products: Product[] = [
    ...
    },
    {
        ...
        emotionalPhrase: 'El detalle que completa su look con naturalidad.',
        price: 20000,
        oldPrice: 30000,
        description: 'Vincha elástica de suavidad extrema. No marca ni aprieta la cabecita de tu bebé.',
        shortDescription: 'Vincha clásica elástica.',
        ...
        use: ['día a día'],
        isFeatured: false,
        benefits: ['Elástico soft', 'No aprieta', 'Colores tierra'],
        materials: ['Nylon premium'],
        care: ['Lavar a mano'],
        productionTime: 'Inmediata',
        guaranteeText: 'Garantía de Confort',
        scarcityText: 'Básico esencial',
    },
    {
        slug: 'vincha-especial-boutique',
        name: 'Vincha Especial',
        emotionalName: 'Corona de Ternura',
        emotionalPhrase: 'Para brillar en sus momentos más dulces.',
        price: 30000,
        oldPrice: 45000,
        description: 'Vinchas con detalles artesanales, flores o moños premium para ocasiones especiales.',
        shortDescription: 'Vincha decorada artesanal.',
        images: ['/images/products/accesorios/Accesorios/f8fb2468-c130-4f46-8952-ec5918a890b7.jpg'],
        category: 'Accesorios',
        gender: 'nena',
        ageRange: '0-6 meses',
        use: ['ocasión especial', 'regalo'],
        isFeatured: true,
        benefits: ['Hecho a mano', 'Detalles premium', 'Estilo boutique'],
        materials: ['Seda', 'Encaje', 'Elástico'],
        care: ['Tratar con cuidado'],
        productionTime: '2-4 días',
        guaranteeText: 'Diseño Exclusivo',
        scarcityText: 'Pieza artesanal',
    },
    {
        slug: 'baberito-bandana-soft',
        name: 'Baberito / Bandana',
        emotionalName: 'Protección con Estilo',
        emotionalPhrase: 'Mantenerlo seco nunca fue tan elegante.',
        price: 35000,
        oldPrice: 50000,
        description: 'Baberito tipo bandana confeccionado en doble capa de algodón absorbente y suave.',
        shortDescription: 'Babero bandana de algodón.',
        images: ['/images/products/accesorios/Accesorios/f8fb2468-c130-4f46-8952-ec5918a890b7.jpg'],
        category: 'Accesorios',
        gender: 'unisex',
        ageRange: '0-6 meses',
        use: ['día a día'],
        isFeatured: false,
        benefits: ['Extra absorbente', 'Broches seguros', 'Suave al tacto'],
        materials: ['Algodón orgánico'],
        care: ['Lavar a máquina'],
        productionTime: 'Inmediata',
        guaranteeText: 'Máxima Absorción',
        scarcityText: 'Un imprescindible',
    },
    {
        slug: 'pack-3-vinchas-premium',
        name: 'Pack de 3 Vinchas',
        emotionalName: 'Trío de Dulzura',
        emotionalPhrase: 'Un color para cada día, una caricia constante.',
        price: 45000,
        oldPrice: 60000,
