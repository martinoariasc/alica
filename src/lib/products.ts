...
export const products: Product[] = [
    ...
    {
        slug: 'cofre-mi-primer-tesoro',
        name: 'Cofre "Mi Primer Tesoro"',
        emotionalName: 'Kit Bienvenida Premium',
        emotionalPhrase: 'Todo lo que su primer año necesita, en un solo cofre.',
        price: 495000,
        oldPrice: 650000,
        description: 'La oferta definitiva para nuevas mamás. Incluye: 1 Mocasín Línea Respetuosa + 1 Botita con Alma + 1 Combo Ternura (Vincha/Baberito) + Packaging de Madera Luxury + Guía Digital "Primeros Pasos Saludables". El valor total real es de 650.000 Gs.',
        shortDescription: 'Kit completo: 2 pares + accesorios + cofre luxury.',
        images: [
            '/images/products/nenas/2/1.png',
            '/images/products/nenes/1/d036d442-5186-4a03-a7bb-c52641120ac6.png',
            '/images/products/nenas/2/2.png'
        ...
        gender: 'unisex',
        ageRange: '0-6 meses',
        use: ['regalo', 'primeros pasos', 'día a día'],
        isFeatured: true,
        benefits: ['Valor total: 650.000 Gs', 'Ahorro inmediato de 155.000 Gs', 'Cofre de madera de regalo', 'Guía de salud incluida'],
        materials: ['Cuero Premium', 'Madera Natural', 'Algodón'],
        care: ['Limpiar con amor'],
        productionTime: '5-7 días',
        guaranteeText: 'Garantía de Calce Perfecto',
        scarcityText: 'Solo 10 cofres por semana',
        isBestSeller: true,
    },
    {
        slug: 'pack-evolucion-alica',
        name: 'Pack Evolución ALICA (3 Etapas)',
        emotionalName: 'Colección Primer Año',
        emotionalPhrase: 'Acompañamos su crecimiento, un talle a la vez.',
        price: 540000,
        oldPrice: 720000,
        description: 'Olvidate de buscar zapatos cada 3 meses. Recibí o elegí 3 pares para sus 3 etapas vitales: 0-6 meses (Gateo), 6-12 meses (Primeros Pasos) y 1-2 años (Exploración). Incluye prioridad VIP en nuevos lanzamientos.',
        shortDescription: '3 pares para las 3 etapas del primer año.',
        images: [
            '/images/products/nenes/2/1.jpg',
            '/images/products/nenes/3/1.png',
            '/images/products/nenes/4/1.png'
        ...
        isFeatured: true,
        benefits: ['Calzado asegurado por 1 año', 'Precio congelado', 'Envío GRATIS en los 3 pares', 'Acceso VIP a preventas'],
        materials: ['Varios materiales premium'],
        care: ['Ver instrucciones de cada par'],
        productionTime: 'Inmediata (primer envío)',
        guaranteeText: 'Plan Crecimiento ALICA',
        scarcityText: 'Solo 5 packs disponibles hoy',
    },
    {
        slug: 'set-gala-ternura',
        name: 'Set Gala & Ternura',
        emotionalName: 'Bautismo & Eventos',
        emotionalPhrase: 'Elegancia impecable para sus momentos inolvidables.',
        price: 320000,
        oldPrice: 410000,
        description: 'La combinación perfecta para eventos. Incluye 1 Mocasín Classic (Nene o Nena) + 1 Accesorio combinando + Tarjeta de Dedicatoria caligrafiada a mano + Caja Boutique con Aroma a Bebé.',
        shortDescription: 'Zapatito de gala + accesorio + detalles luxury.',
        images: [
            '/images/products/nenes/3/1.png',
            '/images/products/nenas/3/0c1ef560-6056-4a67-9f31-18657c222124.png'
        ],
        ...
        use: ['ocasión especial', 'regalo'],
        isFeatured: true,
        benefits: ['Presentación de gala', 'Tarjeta personalizada gratis', 'Perfume de boutique ALICA', 'Ahorro del 25%'],
        materials: ['Sintético Premium', 'Lazo de seda'],
        care: ['Limpiar con paño seco'],
        productionTime: '3-5 días',
        guaranteeText: 'Elegancia Garantizada',
        scarcityText: 'Stock limitado de cajas de gala',
    }
];
