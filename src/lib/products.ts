...
export const products: Product[] = [
    {
        ...
        images: [
            '/images/products/producto-nenas-1.png',
        ],
        category: 'Mocasines',
        gender: 'unisex',
        ageRange: '6-12 meses',
    ...
    },
    {
        ...
        images: [
            '/images/products/botita-1.svg',
            '/images/products/botita-2.svg',
        ],
        category: 'Botitas',
        gender: 'nena',
        ageRange: '6-12 meses',
    ...
    },
    {
        ...
        images: [
            '/images/products/alpargatita-1.svg',
            '/images/products/alpargatita-2.svg',
        ],
        category: 'Sandalias',
        gender: 'nena',
        ageRange: '6-12 meses',
    ...
    },
    {
        ...
        images: [
            '/images/products/vincha-1.svg',
            '/images/products/vincha-especial-1.svg',
        ],
        category: 'Accesorios',
        gender: 'nena',
        ageRange: '0-6 meses',
    ...
    },
    {
        ...
        images: [
            '/images/products/alpargatita-bordado-1.svg',
            '/images/products/alpargatita-bordado-2.svg',
        ],
    ...
    },
    {
        ...
        images: [
            '/images/products/orejita-1.svg',
            '/images/products/orejita-2.svg',
        ],
        category: 'Sandalias',
        gender: 'nena',
        ageRange: '1-2 años',
    ...
    },
    {
        ...
        images: [
            '/images/products/pack-vinchas-1.svg',
            '/images/products/baberito-1.svg',
        ],
        category: 'Accesorios',
        gender: 'nena',
        ageRange: '0-6 meses',
    ...
    {
        id: 'princesa-1',
        slug: 'princesa-real-rose',
        name: 'Princesa Real Rose',
        emotionalName: 'Realeza Suave',
        emotionalPhrase: 'Para los primeros pasos de tu realeza.',
        price: 135000,
        oldPrice: 160000,
        description: 'Detalles de encaje y suavidad extrema. Un diseño pensado para ocasiones especiales donde la comodidad no se negocia.',
        shortDescription: 'Edición especial con encaje y detalles únicos.',
        images: [
        ...
        gender: 'nena',
        ageRange: '0-12 meses',
        use: ['ocasión especial'],
        isFeatured: true,
        sizes: [13, 14, 15, 16, 17, 18],
        stock: 5,
        isNew: true,
        features: ['Suela blanda', 'Encaje premium', 'Ajuste suave'],
        benefits: ['Estilo único', 'Comodidad total', 'Ideal para fotos'],
        materials: ['Encaje suave', 'Algodón'],
    ...
    },
    {
        ...
        emotionalName: 'Magia Pura',
        emotionalPhrase: 'Magia en cada pequeño paso.',
        price: 135000,
        oldPrice: 160000,
        description: 'Un toque de brillo sutil para iluminar sus días. Confeccionados con telas que respiran y protegen.',
        shortDescription: 'Brillo sutil y elegancia atemporal.',
        images: [
        ...
        stock: 5,
        isNew: true,
        features: ['Suela blanda', 'Detalles dorados', 'Ajuste seguro'],
        benefits: ['Look elegante', 'Protección suave', 'Fácil de poner'],
        materials: ['Tela con brillos sutiles', 'Algodón'],
        care: ['Lavado delicado'],
        productionTime: '3 días',
        guaranteeText: 'Amor a primera vista',
        scarcityText: 'Pocas unidades',
    },
    {
        id: 'princesa-3',
        slug: 'princesa-sonadora',
        name: 'Princesa Soñadora',
        emotionalName: 'Dulce Ensueño',
        emotionalPhrase: 'Dulzura que se siente.',
        price: 135000,
        oldPrice: 160000,
        description: 'El rosa más delicado para combinar con todo. Suaves como un abrazo y seguros como el amor de mamá.',
        shortDescription: 'Rosa pastel clásico y delicado.',
        images: [
        ...
        stock: 5,
        isNew: true,
        features: ['Suela blanda', 'Tela respirable', 'Ajuste ergonómico'],
        benefits: ['Comodidad diaria', 'Color versátil', 'Suavidad extra'],
        materials: ['Algodón rosa', 'Forro de algodón'],
        care: ['Lavado normal'],
        productionTime: '2 días',
        guaranteeText: 'Calidad asegurada',
        scarcityText: 'Disponible',
    },
];
