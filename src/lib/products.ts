...
export const products: Product[] = [
    ...
    },
    {
        ...
        oldPrice: 155000,
        description:
            'Aventura en cada paso. Los mocasines Marinero en azul profundo están pensados para los bebés exploradores que no paran. Su diseño clásico con un toque náutico los hace perfectos para cualquier ocasión. La suela flexible permite el agarre natural y el cuero suave protege sin limitar.',
        ...
        isFeatured: true,
        benefits: [
            'Suela de cuero antideslizante',
            'Elástico oculto para calce fácil',
            'Interior de algodón orgánico',
        ],
        materials: ['Cuero vacuno teñido natural', 'Algodón orgánico'],
    ...
    },
    {
        ...
        materials: ['Gamuza premium', 'Bordado de hilo de algodón', 'Forro polar suave'],
    ...
    },
    {
        ...
        materials: ['Cuero vacuno suave', 'Bordado de seda'],
    ...
    },
    {
        ...
        materials: ['Cuero napa blanco premium', 'Forro de algodón orgánico'],
        care: ['Limpiar con paño blanco húmedo', 'Usar crema nutritiva para cuero'],
        productionTime: '2 a 3 días hábiles',
    ...
    },
    {
        ...
        materials: ['Cuero descarne rosa', 'Nylon elástico para vincha', 'Caja de cartón reciclado'],
    ...
    },
    {
        ...
        materials: ['Cuero vacuno engrasado', 'Suela de caucho natural'],
