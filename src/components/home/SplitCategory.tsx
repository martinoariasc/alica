...
export default function SplitCategory() {
    ...
    return (
        <section ref={ref} className="w-full min-h-[80vh] flex flex-col md:flex-row overflow-hidden">
            ...
            <div className="flex-1 relative group h-[50vh] md:h-auto overflow-hidden cursor-pointer">
                ...
                <motion.div
                    className="relative z-10 h-full flex flex-col items-center justify-center text-center p-12 md:p-24"
                    style={{ y: textY }}
                >
