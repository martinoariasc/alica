                ...
                <AnimatedSection>
                    ...
                    >
                        ...
                        <span className="text-sm text-charcoal/80 font-medium">
                            Solo quedan cupos para 8 pedidos esta semana
                        </span>
                    </motion.div>
                    ...
                    <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-semibold text-charcoal mb-6 leading-tight">
                        ¿Lista para elegir el recuerdo
                        <br />
                        <span className="gradient-text">perfecto para tu bebé?</span>
                    </h2>
                    <p className="text-lg text-muted font-light mb-10 max-w-xl mx-auto">
                        ...
                        color ideal. ¡Es muy fácil y rápido!
                    </p>
