            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12 text-center">
                    ...
                    <div className="space-y-6 flex flex-col items-center">
                        ...
                        <p className="text-sm leading-relaxed text-white/70 max-w-xs mx-auto font-light tracking-wide">
                        ...
                        <div className="flex items-center justify-center gap-6 pt-2">
                            ...
                            <a
                                ...
                                className="group relative w-10 h-10 flex items-center justify-center transition-all duration-300 hover:-translate-y-1"
                                aria-label="Instagram"
                            >
                                <div className="absolute inset-0 bg-white/5 rounded-full blur-sm group-hover:bg-white/10 transition-colors" />
                                <svg className="w-5 h-5 text-white/80 group-hover:text-white relative z-10" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            >
                                ...
                                <svg className="w-5 h-5 text-white/80 group-hover:text-[#25D366] relative z-10" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div className="flex flex-col items-center justify-start pt-2">
                        <h3 className="font-heading text-lg font-medium text-white mb-6 tracking-widest text-[10px] uppercase opacity-60">
                            Navegación
                        </h3>
                        ...
                        <div className="space-y-4 text-sm text-white/70 font-light">
                            ...
                            <div className="pt-8 md:pt-10">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-3 px-8 py-3 rounded-full bg-[#25D366] text-white text-[10px] font-bold tracking-widest uppercase hover:bg-[#20BD5A] transition-all duration-300 hover:shadow-lg hover:shadow-[#25D366]/20 hover:-translate-y-0.5"
                                >
                                    Hacer mi pedido
                                </a>
                            </div>
