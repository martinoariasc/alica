                    ...
                    <div className="space-y-4 flex flex-col items-center">
                        ...
                        <div className="flex items-center justify-center gap-4 pt-2">
                            ...
                            <a
                                ...
                                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-rose-deep/80 transition-all duration-300 hover:-translate-y-0.5"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#25D366]/80 transition-all duration-300 hover:-translate-y-0.5"
                                aria-label="WhatsApp"
                            >
                                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className="space-y-4 text-sm text-white/80">
                            ...
                            <div className="pt-4">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#25D366] text-white text-sm font-medium hover:bg-[#20BD5A] transition-all duration-300 hover:-translate-y-0.5"
                                >
                                    Hacer mi pedido
                                </a>
                            </div>
