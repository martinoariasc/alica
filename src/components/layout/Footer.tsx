            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12 text-center">
                    ...
                    <div className="flex flex-col items-center justify-start pt-4">
                        <h3 className="font-heading text-lg font-medium text-white mb-8 tracking-widest text-[10px] uppercase opacity-60">
                            Navegación
                        </h3>
                        ...
                        <div className="space-y-4 text-sm text-white/70 font-light">
                            ...
                            <div className="pt-8 md:pt-12">
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center gap-3 px-8 py-3 rounded-full bg-[#25D366] text-white text-xs font-bold tracking-widest uppercase hover:bg-[#20BD5A] transition-all duration-300 hover:shadow-lg hover:shadow-[#25D366]/20 hover:-translate-y-0.5"
                                >
                                    Hacer mi pedido
                                </a>
                            </div>
